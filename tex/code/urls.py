...
urlpatterns = [
    ...
    path('scroll_epidemic/<int:epidemiology_pk>/more_epidemic_info/'
         '<int:epidemic_pk>/', my_views.more_epidemic_info,
         name = 'more_epidemic_info'),
    path('scroll_epidemic/<int:epidemiology_pk>/more_epidemic_info/'
         '<int:epidemic_pk>/edit_epidemic_info/',
         my_views.edit_epidemic_info, name='edit_epidemic_info'),
    path('scroll_epidemic/<int:epidemiology_pk>/scroll_region/'
         '<int:epidemic_pk>/', my_views.scroll_region,
         name = 'scroll_region'),
    path('scroll_epidemic/<int:epidemiology_pk>/scroll_region/'
